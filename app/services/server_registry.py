...
def _row_to_server(row) -> RegisteredServer:
    ...
    return RegisteredServer(
        ...
        xray_config_path=str(row["xray_config_path"] or "/opt/vpn-manager-node/xray/config.json"),
        ...
        awg_config_path=str(row["awg_config_path"] or "/opt/vpn-manager-node/amnezia-awg/data/wg0.conf"),
    ...
    with _db.transaction() as conn:
        ...
        conn.execute(
            ...
            (
                ...
                bootstrap_state,
                notes,
                "/opt/vpn-manager-node/xray/config.json",
                "xray",
                public_host or ssh_host or "",
                "",
                "",
                ...
                8443,
                "/assets",
                "/opt/vpn-manager-node/amnezia-awg/data/wg0.conf",
                "wg0",
                public_host or ssh_host or "",
                51820,
                "quic",
